...
public partial class DebugUtils : Node
{
    ...
    public static Node2D CreateGlobalPosDebugIcon(Node parent, Vector2 position)
    {
        return DebugUtils.GetInstance(parent)._createGlobalPosDebugIcon(parent, position);
    }
    ...
    private Node2D _createGlobalPosDebugIcon(Node parent, Vector2 position)
    {
